...
using Sample.CommandsAndQueriesApi.MongoDb.HttpResponses;
using Sample.CommandsAndQueriesApi.MongoDb.Pets.Commands;
using Sample.CommandsAndQueriesApi.MongoDb.Pets.Controllers.Requests;
using Sample.CommandsAndQueriesApi.MongoDb.Pets.Entities;
using Sample.CommandsAndQueriesApi.MongoDb.Pets.Queries;

// ReSharper disable SwitchStatementMissingSomeEnumCasesNoDefault

namespace Sample.CommandsAndQueriesApi.MongoDb.Pets.Controllers;
